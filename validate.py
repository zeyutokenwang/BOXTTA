...
from utils.eval_utils import AverageMeter, get_prompts, validate, test_med
...
def main(cfg: Box, ckpt: str = None) -> None:
    ...
    _,_, val_data = load_datasets(cfg, model.model.image_encoder.img_size)
    ...
    test_med(fabric, cfg, model, val_data, name=cfg.name, iters=0)
